  ...
  <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">Era Lintas Data Solusindo</span></a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="#main-header">Beranda</a></li>
                <li class=""><a href="#feature">Tentang</a></li>
                <li class=""><a href="#portfolio">Team</a></li>
                <ul class="nav navbar-nav navbar-right">
                <li class="">
          ...
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">Era lintas Data Solusindo</span></h3>
            </div>
          </div>
        </div>
        </div>
    ...
    <section id="portfolio" class="section-padding wow fadeInUp delay-05s">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">Team</h2>
